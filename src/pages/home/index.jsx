...
export function Home() {
    ...
    return (
        <main className="bg-corHeader">
            <Header />
            <section className="w-full flex items-center h-full bg-fundo bg-no-repeat bg-opacity-80  w-full flex items-center justify-center flex-col bg-bgMain bg-cover md:h-[calc(560px-80px)] md:bg-bgMain md:bg-cover ">
