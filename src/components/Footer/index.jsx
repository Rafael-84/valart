        ...
        <footer className="flex flex-col items-center bg-fundo mt-24  ">
            <div className="flex flex-col gap-5 mt-5 md:flex md:flex-row md:items-center md:justify-between md:w-full lg:w-10/12 4k:w-1/2">
                ...
                <div className='md:mr-16'>
                    ...
                    <div className="flex items-center justify-center gap-2 text-sm text-center my-2 text-indigo-800 font-medium   md:text-base"><FaInstagram  size={20} /><Link title="Instagram" to={instagram} target='_blank' className='hover:text-rose-700 ' >{insta}</Link></div>
                </div>
            </div>
