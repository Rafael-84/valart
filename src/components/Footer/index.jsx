        ...
        <footer className="flex flex-col items-center bg-fundo mt-16  ">
            <div className="flex flex-col gap-5 mt-5 md:flex md:flex-row md:items-center md:justify-between md:w-full lg:w-10/12 4k:w-1/2">
                <div className='md:ml-16'>
                    ...
                    <div className="flex items-center justify-center gap-2  text-sm text-center text-indigo-800 font-medium md:text-base"><FaPhone size={20} /><Link to={urlWhatsApp} className='hover:text-rose-700 '>Telefone: {telefone} </Link></div>
                </div>
                <di className='md:mr-16'>
                    <h2 className="text-center font-bold text-lg text-rose-700  "> Nossas Redes Sociais</h2>
                    <div className="flex items-center justify-center gap-2 text-sm text-center my-2 text-indigo-800 font-medium   md:text-base"><FaInstagram  size={20} /><Link to={instagram} className='hover:text-rose-700 ' >{insta}</Link></div>
                </di>
            </div>
